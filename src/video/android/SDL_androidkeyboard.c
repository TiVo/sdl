...
static SDL_Scancode Android_Keycodes[] = {
    ...
    // TiVo hack -- use F16 for rewind
    SDL_SCANCODE_F16, /* AKEYCODE_MEDIA_REWIND */
    // TiVo hack -- use F17 for fast forward
    SDL_SCANCODE_F17, /* AKEYCODE_MEDIA_FAST_FORWARD */
    ...
    // TiVo hack -- use F21 for record
    SDL_SCANCODE_F21, /* AKEYCODE_MEDIA_RECORD */
    ...
    // TiVo hack -- use F23 for INFO
    SDL_SCANCODE_F23, /* AKEYCODE_INFO */
    // TiVo hack -- use F18 for channel up
    SDL_SCANCODE_F18, /* AKEYCODE_CHANNEL_UP */
    // TiVo hack -- use F19 for channel down
    SDL_SCANCODE_F19, /* AKEYCODE_CHANNEL_DOWN */
    ...
    // TiVo hack -- use F20 for guide
    SDL_SCANCODE_F20, /* AKEYCODE_GUIDE */
    ...
    /** TiVo - use this Apple keyboard specific key to map Android
        "last channel" to a value that is otherwise unused in SDL **/
    SDL_SCANCODE_KBDILLUMDOWN, /* AKEYCODE_LAST_CHANNEL */ /* 229 */
    ...
    /** TiVo - use this Apple keyboard specific key to map Android
        "next channel" to a value that is otherwise unused in SDL **/
    SDL_SCANCODE_KBDILLUMUP, /* AKEYCODE_MEDIA_STEP_FORWARD */ /* 274 */
    /** TiVo - use this Apple keyboard specific key to map Android
        "replay" to a value that is otherwise unused in SDL **/
    SDL_SCANCODE_KBDILLUMTOGGLE, /* AKEYCODE_MEDIA_STEP_BACKWARD */ /* 275 */
    ...
    SDL_SCANCODE_UNKNOWN, /* AKEYCODE_SYSTEM_NAVIGATION_UP */
    SDL_SCANCODE_UNKNOWN, /* AKEYCODE_SYSTEM_NAVIGATION_DOWN */
    SDL_SCANCODE_UNKNOWN, /* AKEYCODE_SYSTEM_NAVIGATION_LEFT */
    SDL_SCANCODE_UNKNOWN, /* AKEYCODE_SYSTEM_NAVIGATION_RIGHT */
    // TiVo hack -- use F22 for "apps"
    SDL_SCANCODE_F22 /* AKEYCODE_ALL_APPS */ /* 284 */
